...
class UsageLedger(Base, TimestampMixin):
    ...
    usage_metadata = Column(JSON)  # Additional context like thread_id, purpose, etc.
...
class RequestLog(Base, TimestampMixin):
    """Request logs for debugging and analysis."""
    ...
    __table_args__ = (
        Index('idx_request_logs_api_key_hash', 'api_key_hash'),
        Index('idx_request_logs_workspace_id', 'workspace_id'),
    )

class Workspace(Base, TimestampMixin):
    """Workspaces for organizing threads and data."""
