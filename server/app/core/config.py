...
class Settings(BaseSettings):
    ...
    # Redis Configuration
    REDIS_URL: str = Field(description="Redis URL for caching and queues")
    
    # DigitalOcean Spaces Configuration
    SPACES_ENDPOINT: str = Field(description="DigitalOcean Spaces endpoint")
    SPACES_REGION: str = Field(description="DigitalOcean Spaces region")
    SPACES_BUCKET: str = Field(description="DigitalOcean Spaces bucket name")
    SPACES_ACCESS_KEY: str = Field(description="DigitalOcean Spaces access key")
    SPACES_SECRET_KEY: str = Field(description="DigitalOcean Spaces secret key")
    ...
    AUTH_API_KEY_SALT: str = Field(description="Salt for API key hashing")
    JWT_SECRET_KEY: str = Field(description="JWT secret key for admin sessions")
